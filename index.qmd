...
<source src="videos/karyoptosis-live-imaging.mp4" type="video/mp4">
...
::: news-box
<p>Prof. Cho, as corresponding author, has had the manuscript <em>Karyoptosis prevents the proliferation of colon cancer cells via p21/Rb-dependent and p53-independent signaling pathways</em> online for publication in [Journal of Pharmaceutical Analysis (IF 11.2)]{.news-journal}.</p>

<p>Prof. Cho, as co-author, has had the manuscript <em>Karyoptosis mediate cell death and neurodegeneration upon proteotoxic stress</em> online for publication in [Nature Communications (IF 14.7)]{.news-journal}.</p>

<p>Prof. Cho, as co-corresponding author, has had the manuscript <em>RPS6KA3/RSK2-mediated phosphorylation of DRAM2 promotes lysosomal targeting and autophagic flux in melanoma</em> online for publication in [Autophagy (IF 14.3)]{.news-journal}.</p>
:::
